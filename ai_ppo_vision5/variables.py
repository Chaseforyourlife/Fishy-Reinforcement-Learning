...
ACCEPT_USER_MOVES = False
DEATH_ON_CONTACT = True
SHIFT_LAST_ADVANTAGE = False
ADD_LAST_STATE = True
SHOW_STATE_SCREEN = True

window_size = (550,400)
#reshape, but maintain width ratio
window_resize = (40,40)#(85,85)#(225,225)#(225,225*3)#(550,400*3)#(75,75*3)#(75,75)#(225,225)# (550,400) #(225,225)
MAX_FISH = 1#8
MAX_FISH_SPEED = 6 #6
MIN_FISH_SPEED = 2 #2
...
LEARNING_RATE = .0006#.00006#.00006#.0006#.01#.0003#.0003#.0003#.001
